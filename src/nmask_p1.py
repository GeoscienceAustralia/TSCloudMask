...
def main():
    ...
    if ( argc != 13 ):
        ...
        print("Usage: python3 nmask_p1.py y1 y2 x1 x2 crs out_crs start_of_epoch end_of_epoch dirc indstr outdirc loc_str tmpdir")  
        ...
        print("dirc: input directory for indices means")
        print("indstr: file name of indices means")
    ...
    # projection string, such as EPSG:3577, EPSG:4326,  
    crs = param[5]
    ...
    # End of time epoch
    end_of_epoch = param[8]

    # input directory for indices means
    dirc = param[9]

    #  file name of indices means
    indstr = param[10]
    ...
    #comm ='mkdir -p '+ tmpdirc 
    #os.system(comm)

    
    bgids = load_bgids(dirc, indstr, loc_str)
    ...
    print("Begin creating input features for Nmask ANN model")
    create_ip_data(s2_ds, bgids, loc_str, outdirc)
